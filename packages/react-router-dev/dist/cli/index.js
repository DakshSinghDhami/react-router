 ...
 * @license MIT
 */
import { g as preloadVite, h as getVite, l as loadConfig, n as watch, t as run$1 } from "../typegen-C67wKp8N.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-ENIX-Jf0.js");
...
async function dev(root, options = {}) {
	let { dev } = await import("../dev-D4_dKtjW.js");
	if (options.profile) await start();
