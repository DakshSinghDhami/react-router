 ...
 * @license MIT
 */
import { g as preloadVite, h as getVite, l as loadConfig, n as watch, t as run$1 } from "../typegen-BTO74_HQ.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-BHLU9w2N.js");
...
async function dev(root, options = {}) {
	let { dev } = await import("../dev-BYhsXPaj.js");
	if (options.profile) await start();
